...
class EmbeddingServiceSettings(CommonAppSettings):
    ...
    model_config = SettingsConfigDict(
        # Quitamos el prefijo para que pueda heredar correctamente las variables de CommonAppSettings
        env_prefix='',
        extra='ignore',
        env_file='.env'
    )
    ...
    service_name: str = Field("embedding", description="Nombre del servicio.")
